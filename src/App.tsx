      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: isMobile ? 'wrap' : 'nowrap', justifyContent: isMobile ? 'flex-end' : 'flex-start' }}>
              {!isMobile ? (
                <Button
              ...
              <Button
                ...
                size="small"
                style={{
                  background: isMobile ? '#ffffff' : isDarkMode ? 'rgba(15, 23, 42, 0.35)' : 'rgba(255,255,255,0.95)',
                  borderColor: isMobile ? 'rgba(255,255,255,0.85)' : isDarkMode ? 'rgba(226,232,240,0.35)' : 'rgba(15,23,42,0.18)',
                  color: isMobile ? '#4f46e5' : isDarkMode ? 'rgba(255,255,255,0.92)' : 'rgba(15,23,42,0.92)',
                  fontWeight: 600,
                  boxShadow: isMobile ? '0 6px 16px rgba(0,0,0,0.12)' : undefined,
                  fontSize: 13,
                  height: 28,
                  padding: '0 10px',
                }}
